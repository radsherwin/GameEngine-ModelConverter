...
Vert_xyzuvn  pyramidData[] =
{
	...
	{ 0.0f, 0.25f, 0.0f, 		 0.5f, 0.5f,	 0.0f, 0.0f, 1.0f}, //A 0
	{-0.5f, -0.25f,	-0.5f,		 0.0f, 1.0f,	-0.4f, -0.4f, -0.8f}, //B 1
	{ 0.5f, -0.25f,	-0.5f,		 1.0f, 1.0f,	 0.4f, -0.4f, -0.8f}, //C 2
	{ 0.5f, -0.25f,	 0.5f,		 1.0f, 0.0f,     0.4f, 0.4f, -0.8f}, //D 3
	{-0.5f, -0.25f,	 0.5f,		 0.0f, 0.0f,    -0.4f, 0.4f, -0.8f} //E 4

};

#endif

void PyramidMesh::privCreateVAO(const char* const pMeshFileName)
{
	...
	//object name
	strncpy_s(meshHdr.objName, MeshFileHdr::OBJECT_NAME_SIZE, "Pyramid", _TRUNCATE);
	...
	Vert_xyzuvn* pPyramidData = new Vert_xyzuvn[(unsigned int)meshHdr.numVerts];
...
PyramidMesh::PyramidMesh(const char* const pMeshFileName)
	: Mesh()
{
	assert(pMeshFileName);
